...
const (
	...
	CriuReqType_ITERATIVE_DUMP   CriuReqType = 14
)
...
type CriuOpts struct {
	...
	DirtyFile            *string                `protobuf:"bytes,72,opt,name=dirty_file,json=dirtyFile" json:"dirty_file,omitempty"`
	LiveMigration        *bool                  `protobuf:"varint,73,opt,name=live_migration,json=liveMigration" json:"live_migration,omitempty"` //	optional bool			check_mounts		= 128;
}
...
func (x *CriuOpts) GetDirtyFile() string {
	if x != nil && x.DirtyFile != nil {
		return *x.DirtyFile
	}
	return ""
}

func (x *CriuOpts) GetLiveMigration() bool {
	if x != nil && x.LiveMigration != nil {
...
var file_rpc_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x69, 0x6e, 0x6f, 0x64, 0x65, 0x22, 0xaa, 0x14, 0x0a, 0x09, 0x63, 0x72, 0x69, 0x75,
	0x5f, 0x6f, 0x70, 0x74, 0x73, 0x12, 0x26, 0x0a, 0x0d, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x73, 0x5f,
	0x64, 0x69, 0x72, 0x5f, 0x66, 0x64, 0x18, 0x01, 0x20, 0x02, 0x28, 0x05, 0x3a, 0x02, 0x2d, 0x31,
	...
	0x08, 0x52, 0x0b, 0x6c, 0x6f, 0x67, 0x54, 0x6f, 0x53, 0x74, 0x64, 0x65, 0x72, 0x72, 0x12, 0x1d,
	0x0a, 0x0a, 0x64, 0x69, 0x72, 0x74, 0x79, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x48, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x09, 0x64, 0x69, 0x72, 0x74, 0x79, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x25, 0x0a,
	0x0e, 0x6c, 0x69, 0x76, 0x65, 0x5f, 0x6d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	0x49, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x6c, 0x69, 0x76, 0x65, 0x4d, 0x69, 0x67, 0x72, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x2c, 0x0a, 0x0e, 0x63, 0x72, 0x69, 0x75, 0x5f, 0x64, 0x75, 0x6d,
	...
	0x07, 0x56, 0x4d, 0x5f, 0x52, 0x45, 0x41, 0x44, 0x10, 0x02, 0x2a, 0xf9, 0x01, 0x0a, 0x0d, 0x63,
	...
	0x10, 0x0d, 0x12, 0x12, 0x0a, 0x0e, 0x49, 0x54, 0x45, 0x52, 0x41, 0x54, 0x49, 0x56, 0x45, 0x5f,
	0x44, 0x55, 0x4d, 0x50, 0x10, 0x0e, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f, 0x3b, 0x72, 0x70, 0x63,
}
